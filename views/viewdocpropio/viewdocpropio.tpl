                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{$baseUrl}documentospropios"><i class="fas fa-home"></i> Regresar </a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card card-dark  card-outline">
                            ...
                            <div class="card-body p-0" style="background-color: #f8f9fa;">
                                <div class="pdf-container">
                                    <iframe 
                                        src="{$baseUrl}viewdocpropio/previsualizarPDF/{$documento_propio_id}" 
                                        class="pdf-viewer"
                                        allowfullscreen>
                                    </iframe>
                                </div>
                        ...
                        <div class="card card-dark  card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    {elseif $folioDoc && $firmantesFirmados == $totalFirmantes}
                                        <i class="fas fa-check-circle mr-2"></i> Firmas recolectadas {$firmantesFirmados}/{$totalFirmantes} <br>
                                        <span class="text-muted">Folio: {$folioDoc}</span>
                                    {elseif $folioDoc}
                                        <button
                                                    type="button"
        ...
        if (btnSolicitar) {
            btnSolicitar.onclick = function() {
                if (window.confirm('¿Estás seguro de solicitar las firmas digitales? No podrás revertir esta acción.')) {
                    ...
                    setTimeout(function() {
                        fetch('{$baseUrl}viewdocpropio/generarCadenaYFirma/{$documento_propio_id}')
