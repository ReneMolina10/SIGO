<?php /* Smarty version Smarty-3.1.8, created on 2025-07-03 17:16:29
         compiled from "/opt/sitios/sigo/views/viewminuta/viewminuta.tpl" */ ?>
<?php /*%%SmartyHeaderCode:260682626866c5d6799c03-93957467%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '872943f99b9c870c6f637ffa3557994b4d6fc2c8' => 
    array (
      0 => '/opt/sitios/sigo/views/viewminuta/viewminuta.tpl',
      1 => 1751577387,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '260682626866c5d6799c03-93957467',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_6866c5d67da883_22132453',
  'variables' => 
  array (
    'baseUrl' => 0,
    'minuta_id' => 0,
...
<?php if ($_valid && !is_callable('content_6866c5d67da883_22132453')) {function content_6866c5d67da883_22132453($_smarty_tpl) {?><div class="wrapper" style="height: 90vh;">
...
/<?php echo $_smarty_tpl->tpl_vars['totalFirmantes']->value;?>
                                ...
                                <?php }elseif($_smarty_tpl->tpl_vars['folioDoc']->value){?>
                                    <button
                                        ...
                                        class="btn btn-block btn-secondary rounded-pill py-2 shadow-sm btn-outline-hover"
                    ...
                    .then(data => {
                        ...
                        if (btnVerificar) {
                            btnVerificar.onclick = function() {
                                ...
                                fetch('<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
viewminuta/getFirma/<?php echo $_smarty_tpl->tpl_vars['minuta_id']->value;?>
')
                                    .then(response => response.json())
                                    .then(data => {
                                        location.reload();
                                    ...
                                    .catch(() => {
                                        btn.disabled = false;
                                        btn.innerHTML = '<i class="fas fa-sync-alt mr-2"></i> Verificar estatus de firmas';
                                        alert('Ocurrió un error al verificar el estatus de las firmas.');
                                    });
                            };
                        }
                    })
