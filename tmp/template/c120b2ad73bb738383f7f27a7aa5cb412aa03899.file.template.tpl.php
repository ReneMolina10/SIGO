<?php /* Smarty version Smarty-3.1.8, created on 2025-07-14 11:39:42
         compiled from "/opt/sitios/sigo/views/layout/login/template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:508257099687524be1f7ba2-82449297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c120b2ad73bb738383f7f27a7aa5cb412aa03899' => 
    array (
      0 => '/opt/sitios/sigo/views/layout/login/template.tpl',
      1 => 1751570845,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '508257099687524be1f7ba2-82449297',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_687524be213316_08125358',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_687524be213316_08125358')) {function content_687524be213316_08125358($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
...
files/layouts/LTE2/dist/css/adminlte.css">
  ...
  <style>
    ...
    body {
      background-image: url('https://sau2.uqroo.mx/public/img/<?php echo $_smarty_tpl->tpl_vars['imgfondo']->value;?>
');
...
<body>
  <div class="login-container">
    <div class="login-logo">
      <h3><?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['configs']['app_name'];?>
</h3>
    </div>
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
      <strong>¡Atención!</strong> <?php echo $_smarty_tpl->tpl_vars['_error']->value;?>
      ...
      <div class="collapse" id="collapseManualLogin">
        <form name="form1" method="post" action="" class="mt-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="username" name="usuario" class="form-control" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['datos']->value['usuario'])===null||$tmp==='' ? '' : $tmp);?>
