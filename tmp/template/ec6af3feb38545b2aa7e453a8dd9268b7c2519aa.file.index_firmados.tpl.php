<?php /* Smarty version Smarty-3.1.8, created on 2025-08-17 02:26:59
         compiled from "C:\xampp\htdocs\SIGO\views\doc_firmados\index_firmados.tpl" */ ?>
<?php /*%%SmartyHeaderCode:57647076568a1682e993827-14823943%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec6af3feb38545b2aa7e453a8dd9268b7c2519aa' => 
    array (
      0 => 'C:\\xampp\\htdocs\\SIGO\\views\\doc_firmados\\index_firmados.tpl',
      1 => 1755415618,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '57647076568a1682e993827-14823943',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_68a1682e9b7481_31599586',
  'variables' => 
  array (
    'documentos' => 0,
    'doc' => 0,
...
<?php if ($_valid && !is_callable('content_68a1682e9b7481_31599586')) {function content_68a1682e9b7481_31599586($_smarty_tpl) {?>
<style>
    .page-header-custom {
...
<div class="table-responsive">
    <table id="grid_docs_firmados" class="stripe hover order-column table-sm cell-border compact" style="width:100%">
        ...
        <tbody>
        <?php if (isset($_smarty_tpl->tpl_vars['documentos']->value)&&count($_smarty_tpl->tpl_vars['documentos']->value)){?>
...
?>
                <?php $_smarty_tpl->tpl_vars['pct'] = new Smarty_variable(0, null, 0);?>
                <?php if ($_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_TOTAL']>0){?>
                    <?php $_smarty_tpl->tpl_vars['pct'] = new Smarty_variable($_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_FIRMADOS']/$_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_TOTAL']*100, null, 0);?>
                <?php }?>
                <tr>
                    <td><?php echo $_smarty_tpl->tpl_vars['doc']->value['TDOC_DOCUMENTO'];?>
</td>
                    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['doc']->value['TDOC_FOLIO'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                    <td class="col-estado">
                        <?php if ($_smarty_tpl->tpl_vars['doc']->value['TDOC_ESTATUS']==3){?>
                            <span class="badge badge-success">FIRMADO</span>
                        <?php }elseif($_smarty_tpl->tpl_vars['doc']->value['TDOC_ESTATUS']==2){?>
                            <span class="badge badge-warning">EN PROCESO</span>
                        <?php }else{ ?>
                            <span class="badge badge-info"><?php echo $_smarty_tpl->tpl_vars['doc']->value['TDOC_ESTATUS'];?>
</span>
                        <?php }?>
                    </td>
                    <td class="col-firmantes">
                        <?php if ($_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_FIRMADOS']==$_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_TOTAL']){?>
                            <span class="badge badge-success"><?php echo $_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_FIRMADOS'];?>
/<?php echo $_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_TOTAL'];?>
</span>
                        <?php }else{ ?>
                            <a href="#" class="badge badge-warning ver-firmantes"
                               data-toggle="modal"
                               data-target="#modalFirmantes"
                               data-doc="<?php echo $_smarty_tpl->tpl_vars['doc']->value['TDOC_DOCUMENTO'];?>
">
                               Ver firmantes<br><?php echo $_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_FIRMADOS'];?>
/<?php echo $_smarty_tpl->tpl_vars['doc']->value['FIRMANTES_TOTAL'];?>

                            </a>
                        <?php }?>
                    </td>
                    <td><?php echo $_smarty_tpl->tpl_vars['doc']->value['TDOC_FECHA_FIRMA'];?>
</td>
                    <td><?php echo $_smarty_tpl->tpl_vars['doc']->value['TDOC_FECHA'];?>
</td>
                    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['doc']->value['ORIGEN'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['doc']->value['TIPO'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                    <td>
                        <a href="https://efirma.uqroo.mx/verify/<?php echo $_smarty_tpl->tpl_vars['doc']->value['TDOC_FOLIO'];?>
...
<?php $_smarty_tpl->tpl_vars['firmantesJson'] = new Smarty_variable(json_encode($_smarty_tpl->tpl_vars['firmantesDocs']->value), null, 0);?>


<script>
(function(){
  const FIRMANTES = <?php echo $_smarty_tpl->tpl_vars['firmantesJson']->value;?>
;
