<?php /* Smarty version Smarty-3.1.8, created on 2025-07-07 14:26:55
...
<?php if ($_valid && !is_callable('content_6866c5f8b720c4_45031814')) {function content_6866c5f8b720c4_45031814($_smarty_tpl) {?><style>
    ...
    /* Quitar borde superior de las celdas en el encabezado de la tabla */
    .table-bordered thead th, 
    .table-bordered thead td {
        border-top: none !important;
    }
    /* Quitar borde superior del encabezado de la tarjeta */
    .card-header {
        border-top: none !important;
    }
    /* Bordes y fondo blanco en el encabezado de la tabla */
    .table thead th {
...
<div class="card">
    <div class="card-header">
        <!-- Botón para registrar un elemento usando una función JavaScript -->
...
');">
            Registrar <?php echo mb_strtolower($_smarty_tpl->tpl_vars['f']->value['nombre'], 'UTF-8');?>

        </a>
        <!-- Botón para abrir un modal usando una función JavaScript -->
...
');">
    ...
    <div class="card-body">
       <div class="table-responsive">
            <!-- Tabla con encabezado dinámico y cuerpo vacío -->
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <!-- Configuración dinámica de anchos de columna -->
...
;"></th>
                ...
                <!-- Cuerpo de la tabla con ID dinámico -->
                <tbody id="tabla_<?php echo $_smarty_tpl->tpl_vars['f']->value['nombre'];?>
">
                    <!-- Aquí se generarán dinámicamente las filas con las acciones -->
                </tbody>
            </table>
        </div>
    </div>
...
<!-- Modal para mostrar un formulario dinámico -->
<div class="modal fade" id="modal_formulario" tabindex="-1" role="dialog" aria-labelledby="modal_formulario_label" aria-hidden="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <!-- Formulario dinámico dentro del modal -->
            <form class="bs-example bs-example-form" id="formp" name="formp" action="javascript:guardar_generator('<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
...
<script type="text/javascript">
    // Función para validar y abrir una URL dinámica
...
'+gen+'/editar_modal/'+idAbrir,
                ...
                success: function(response) {
                    ...
                    $('#btnguardar').off('click').on('click', function() {
                        guardar_generator('<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
<?php echo $_smarty_tpl->tpl_vars['controlador']->value;?>
');
                    });
                },
    ...
    // Función para actualizar el contenido de la tabla dinámicamente
...
'
    ...
    $(document).ready(function() {
        // Actualizar la tabla al cargar la página si hay un ID relacionado
        if ($('#<?php echo $_smarty_tpl->tpl_vars['f']->value['idrel'];?>
').val() != "") {
...
").html(
        ...
        // Actualización automática de la tabla cada 10 segundos
