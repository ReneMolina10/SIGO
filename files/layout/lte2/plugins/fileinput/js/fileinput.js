        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    html: {width: '213px', height: '260px'},
                    text: {width: '213px', height: '260px'},
                    office: {width: '213px', height: '260px'},
                    gdocs: {width: '213px', height: '260px'},
                    video: {width: '213px', height: '260px'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '213px', height: '260px'},
                    object: {width: '213px', height: '260px'},
                    pdf: {width: '100%', height: '260px', 'position': 'relative'},
                    other: {width: '213px', height: '260px'}
                },
                previewSettingsSmall: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: {width: '100%', height: '260px'},
                    text: {width: '100%', height: '260px'},
                    office: {width: '100%', height: '260px'},
                    gdocs: {width: '100%', height: '260px'},
                    video: {width: '100%', height: 'auto'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '100%', height: 'auto'},
                    object: {width: '100%', height: 'auto'},
                    pdf: {width: '100%', height: '260px'},
                    other: {width: '100%', height: '260px'}
                },
                previewZoomSettings: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: vDefaultDim,
