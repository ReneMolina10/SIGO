   ...
   ',
    ...
    'btnOpciones' => array(
        ...
        'metadato' => array(
            ...
            'href' => "https://sigo.uqroo.mx/viewminuta/extraerMetadatosPDF/[HASHDOC]",
            'target' => '_blank',
            'class' => 'text-primary',
            'mostrar_si' => '"[HASHDOC]" != ""'
        ),
        'fopen' => array(
            ...
            'href' => "https://sigo.uqroo.mx/viewminuta/binFOpen/[HASHDOC]",
            'target' => '_blank',
            'class' => 'text-primary',
            'mostrar_si' => '"[HASHDOC]" != ""'
        ),
        'generarCadenaMinuta' => array(
            ...
            'href' => "https://sigo.uqroo.mx/viewminuta/generarCadenaMinuta/[HASHDOC]",
            'target' => '_blank',
            'class' => 'text-primary',
            'mostrar_si' => '"[HASHDOC]" != ""'
        ),
...
'
    ...
    array(
        ...
        'bd' => array(
            'sqlDeplegar' => "SELECT 
                                    ...
                                    MY_DECRYPT(ASU_RESUMEN, '$S_key') as RESUMEN,
                                    ASU_FK_MINUTA,
    ...
    array(
        ...
        'bd' => array(
            'sqlDeplegar' => "SELECT
                            ACU_ID AS ID,
                            MY_DECRYPT(ACU_DESCRIPCION, '$S_key') AS DESCRIPCION,
    ...
    array(
        ...
        'bd' => array(
            'sqlDeplegar' => "SELECT
                                    MEJ_ID AS ID, 
                                    MEJ_TIPO AS TIPO, 
                                    MY_DECRYPT(MEJ_DESCRIPCION, '$S_key') AS DESCRIPCION, 
                                    MEJ_FK_MINUTA, 
                                    DM.STATUS_DOC
