...
$bd = array(
    ...
    DP_DENOMINACION,
    MY_DECRYPT(dp_descripcion, \'' . $S_key . '\') AS DESCRIPCION,
    DP_FOLIO AS FOLIO,
    DP_FECHA AS FECHA,
    DP_STATUS_DOC,
    DP_RUTA_PDF,
    CORREO_CREADOR,
    MD5(DP_ID||\'_docpro\') AS HASHDOC,
                CASE
                    -- 1. Sin firmantes
    ...
    'btnOpciones' => array(
        ...
        'ver_doc' => array(
            'label' => '<i class="far fa-eye"></i> Ver documento',
            'href' => BASE_URL . 'viewdocpropio/previsualizarpdf/[HASHDOC]',
            'target' => '_blank',
            'class' => 'text-dark',
            'mostrar_si' => '"[HASHDOC]" != ""'
        ),
        'metadato' => array(
            'label' => '<span class="btn btn-info btn-sm btn-block" style="margin-bottom:3px;"><i class="far fa-eye"></i> Metadatos</span>',
            'href' => "https://sigo.uqroo.mx/viewdocpropio/extraerMetadatosPDF/[HASHDOC]",
            'target' => '_blank',
            'class' => 'text-primary',
            'mostrar_si' => $correoUsuario == '1823329@uqroo.mx'
        ),
        'fopen' => array(
            'label' => '<span class="btn btn-secondary btn-sm btn-block"><i class="far fa-eye"></i> FOpen</span>',
            'href' => "https://sigo.uqroo.mx/viewdocpropio/binFOpen/[HASHDOC]",
            'target' => '_blank',
            'class' => 'text-primary',
            'mostrar_si' => $correoUsuario == '1823329@uqroo.mx'
        ),
        'generarCadenaMinuta' => array(
            'label' => '<span class="btn btn-dark    btn-sm btn-block"><i class="far fa-eye"></i> generar Cadena</span>',
            'href' => "https://sigo.uqroo.mx/viewdocpropio/generarCadenaOriginal/[HASHDOC]",
            'target' => '_blank',
            'class' => 'text-primary',
            'mostrar_si' => $correoUsuario == '1823329@uqroo.mx'
        ),
...
$form = array(
    ...
    array('etiq' => '<div class="row"> <div class="col-md-7"> '),
...
*/
    ...
    array(
        ...
        'bd' => array(
            'sqlDeplegar' => "SELECT 
                                    ...
                                    DP_NUMEMPL||' - '||DP_PREFIJOESTUDIOS||' '|| DP_NOMBRE || ' ('|| DP_CORREO || ') <br/>' ||DP_CARGO AS FIRMANTE,
                                    DP_CURP AS CURP, 
    ...
    array('etiq' => '</div> </div> <div class="col-md-5">  <div class="row">'),
            array(
                'col' => 'col-md-12',
                'campo' => 'DP_RUTA_PDF',
